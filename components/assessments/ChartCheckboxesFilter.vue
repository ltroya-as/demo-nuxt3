<template>
  <div>
    <div
      class="border-s-300 lg:border-s-500 mb-3 border-b pb-3 text-sm font-semibold capitalize"
      ...
      >
        <div class="flex items-center">
          ...
          >
            ...
            />
            <span
              class="text-s-900 w-full text-sm font-semibold capitalize lg:ml-3 lg:text-white"
            >
              {{ option.name }}
            </span>
          </label>
...
export default {
  ...
  computed: {
    filterValue: {
      ...
      set(value) {
        this.$emit('updated-header', { name: this.filter.name, value })
      },
    },
  },
}
