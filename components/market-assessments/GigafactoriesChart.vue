  ...
  <div>
    ...
    >
        ...
        <div class="w-full">
          ...
          <div class="remove-me hidden xl:block">
            <MarketAssessmentsFilterLayout
              ...
              :show-benchmark-verified-box="isGigafactories"
              :options="companies"
              ...
              <template #benchmarkMultiSelect>
                ...
                >
                  ...
                  >
                    ...
                    />
                    <span
                      class="min-w-[160px] text-sm font-semibold text-white"
                    >
                      {{ state.label }}
                    </span>
                    <component
                      :is="statusIcons[state.slug]"
                      class="h-4 w-auto"
                    />
                  </label>
                </div>
          ...
          <template #summaryBox>
            <div class="flex flex-row gap-1">
              ...
              >
                ...
                <div>{{ labelTotal }}</div>
                <div>{{ filteredCapacityLabel }} ({{ capacityUnit }}):</div>
              </div>
              <div
      ...
      <div class="flex w-full flex-col lg:mx-0">
        ...
        >
          {{ mineral }} capacity estimates, by {{ stringifyYears(years) }}
        </div>
        ...
        <div class="relative" :class="{ flex: isGigafactories }">
          <div
            v-if="isGigafactories"
            class="mt-[66px] flex w-1/2 flex-col justify-around text-end"
          >
            <div
...
export default {
  ...
  computed: {
    ...
    regionNames() {
      const names = this.regions.map((region) => region.name)
  ...
  methods: {
    ...
    stringifyYears(years) {
      const labelYear = years.map((year) => {
        return year.split(' ')[0]
      })
      return `${labelYear.slice(0, -1).join(', ')}, and ${labelYear.slice(-1)}`
    },
