<template>
  <section class="price-assessments-articles">
    <section class="mb-4">
      <div class="grid grid-cols-12 gap-x-4" :data-testid="`${slug}-analysis`">
        <!-- Articles -->
        <div
          class="col-span-12 grid gap-4 xl:grid-cols-3 xl:grid-rows-2"
