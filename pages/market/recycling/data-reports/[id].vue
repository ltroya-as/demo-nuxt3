...
import { BLACK_MASS, MARKET } from '~/constants/services/constants'
...
export default {
  ...
  data() {
    return {
      reportId: null,
      reportCategory: BLACK_MASS.categoryReportPricing,
      product: BLACK_MASS.slug,
    }
  },
  head() {
    return this.generateSeoInfo({
      title: `${MARKET.name}: ${BLACK_MASS.name} Report`,
