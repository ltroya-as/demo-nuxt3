  ...
  <div class="relative w-full flex-grow">
    <div class="gap-x-big absolute hidden h-full w-full lg:grid lg:grid-cols-2">
      <div
        ...
        class="bg-black bg-[url('https://res.cloudinary.com/benchmarkminerals/image/upload/c_fill,q_auto,g_auto,w_1246,f_auto/v1703089934/assets/newsletter/BG_qetet0.png')] bg-cover bg-center bg-no-repeat"
      ></div>
    </div>
    <div
    ...
    >
      <div
        class="px-small lg:pl-big w-full bg-black bg-[url('https://res.cloudinary.com/benchmarkminerals/image/upload/c_fill,q_auto,g_auto,w_1015,f_auto/v1703096818/assets/newsletter/Mask_group_fwggwl.png')] bg-cover bg-[center_bottom_25%] bg-no-repeat pb-96 pt-3 text-white lg:min-h-[1000px] lg:bg-inherit lg:bg-none lg:pb-32 2xl:px-0"
      >
        <div class="bg-black/10 pb-3 backdrop-blur-sm">
          <FreePricesNavigation class="mb-6 lg:mb-5" active-menu="Newsletter" />
          <h3
...
export default {
  ...
  setup() {
    ...
    const seo = getSeoInfo({ title: 'Newsletter' })
